...
from smithcore.core.queue import ClaimedItem, FinalStatus, LeaseRenewable, Queue
...
current_transaction_id: ContextVar[str | None] = ContextVar(
    "smithcore_transaction_id", default=None
)
